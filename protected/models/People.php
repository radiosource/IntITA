...
class People extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('firstName, lastName, phone, birthDate', 'required'),
			array('phone, item_order', 'numerical', 'integerOnly'=>true),
			array('firstName, lastName', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, firstName, lastName, phone, birthDate, item_order', 'safe', 'on'=>'search'),
		);
	}
