...
<p>Для получения более подробной информации по настройке и управлению правами доступа на Вашем форуме phpBB3 смотрите <a href="https://www.phpbb.com/support/documentation/3.0/quickstart/quick_permissions.html">Раздел 1.5 нашего руководства</a>.</p>
	',

	'ACL_NEVER'					=> 'Никогда',
	'ACL_SET'					=> 'Настройка прав доступа',
	'ACL_SET_EXPLAIN'			=> 'Права доступа основаны на простой системе <strong>ДА</strong>/<strong>НЕТ</strong>. Установление значения <strong>НИКОГДА</strong> для пользователя или группы означает игнорирование любых иных значений, установленных по данной опции. Если Вы не хотите назначать право по опции для данного пользователя или группы выберите <strong>НЕТ</strong>. Если значения по этой опции установлены где-нибудь еще, они будут иметь более высокий приоритет, если не установлено <strong>НИКОГДА</strong>. Все отмеченные объекты (с установленным флажком) отображают установленные значения прав доступа.',
