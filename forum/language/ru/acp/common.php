...
$lang = array_merge($lang, array(
	...
	'ACP_EXTENSION_GROUPS'			=> 'Управление вложениями расширений групп',
	...
	'ACP_GROUPS_POSITION'			=> 'Управление должностями в группе',
	...
	'ACP_MANAGE_ATTACHMENTS_EXPLAIN'	=> 'Здесь Вы можете просматривать и удалять файлы, вложенные в личные сообщения и сообщения на форуме.',
	...
	'LOAD_NOTIFICATIONS'			=> 'Отображать уведомления',
	'LOAD_NOTIFICATIONS_EXPLAIN'	=> 'Отображать список уведомлений на каждой странице (обычно в хедере).',
	...
	'NO_FILES_TO_DELETE'	    => 'Вложений, которые Вы выбрали для удаления, не существует.',
...
$lang = array_merge($lang, array(
	...
	'PURGE_CACHE_SUCCESS'		=> 'Кеш успешно очищен.',
	...
	'PURGE_SESSIONS_SUCCESS'	=> 'Сессии успешно удалены.',
	...
	'RESET_ONLINE_SUCCESS'				=> 'Сброс наибольшего количество посетилей онлайн успешно произведен',
	...
	'RESYNC_POSTCOUNTS_SUCCESS'			=> 'Сообщения успешно синхронизированы',
	...
	'RESYNC_POST_MARKING_SUCCESS'		=> 'Синхронизировать точечные темы',
	...
	'TIMEZONE_INVALID'				=> 'Часового пояса, который Вы выбрали, не существует .',
	'TIMEZONE_SELECTED'				=> '(выбранный)',
...
$lang = array_merge($lang, array(
	...
	'LOG_POST_RESTORED'				=> '<strong>Восстановленное сообщение</strong><br />В» %s',
	'LOG_REPORT_CLOSED'				=> '<strong>Закрытие жалобы</strong><br />» %s',
	'LOG_REPORT_DELETED'			=> '<strong>Удаление жалобы</strong><br />» %s',
	'LOG_RESTORE_TOPIC'				=> '<strong>Восстановленная тема вЂњ%1$sвЂќ написана</strong><br />В» %2$s',
	...
	'LOG_TOPIC_RESTORED'			=> '<strong>Восстановленная тема</strong><br />В» %s',
	...
	'LOG_PLUPLOAD_TIDY_FAILED'	=> '<strong>Невозможно открыть %1$s для упорядочивания, проверьте права доступа.</strong><br />Исключение: %2$s<br />Trace: %3$s',
	...
	'LOG_SPHINX_ERROR'				=> '<strong>Sphinx Error</strong><br />В» %s',
