...
$lang = array_merge($lang, array(
	...
	'ACL_CAT_POST'			=> 'Сообщения',
	'ACL_CAT_POST_ACTIONS'	=> 'Действия с сообщениями',
	'ACL_CAT_POSTING'		=> 'Публикация',
	'ACL_CAT_PROFILE'		=> 'Профиль',
	'ACL_CAT_SETTINGS'		=> 'Настройки',
	'ACL_CAT_TOPIC_ACTIONS'	=> 'Действия с темами',
	'ACL_CAT_USER_GROUP'	=> 'Пользователи &amp; Групп',
));

// User Permissions
$lang = array_merge($lang, array(
	'ACL_U_VIEWPROFILE'	=> 'Может просматривать профили, списки пользователей и кто сейчас на форуме',
	'ACL_U_CHGNAME'		=> 'Может менять имя',
	'ACL_U_CHGPASSWD'	=> 'Может менять пароль',
	'ACL_U_CHGEMAIL'	=> 'Может менять e-mail адрес',
	'ACL_U_CHGAVATAR'	=> 'Может менять аватар',
	...
	'ACL_U_MASSPM'		=> 'Может рассылать сообщения нескольким пользователям',
	'ACL_U_MASSPM_GROUP'=> 'Может рассылать сообщения группам',
	...
	'ACL_U_PM_EMAILPM'	=> 'Может отправлять ЛС по e-mail',
	...
	'ACL_U_PM_IMG'		=> 'Может использовать BBCode [img] в ЛС',
	'ACL_U_PM_FLASH'	=> 'Может использовать BBCode [flash] в ЛС',

	'ACL_U_SENDEMAIL'	=> 'Может посылать e-mail сообщения',
...
$lang = array_merge($lang, array(
	...
	'ACL_F_EMAIL'		=> 'Может сообщать (другу) по e-mail о теме',
	...
	'ACL_F_SOFTDELETE'	=> 'Может помечать сообщения как удаленные<br /><em>Модераторы, у кторых есть право утверждать сообщения, могут восстанавливать сообщения помеченные как удаленные.</em>',
	'ACL_F_IGNOREFLOOD' => 'Может игнорировать флуд-контроль',
	'ACL_F_POSTCOUNT'	=> 'Счетчик сообщений включен<br /><em>Учтите, что данная установка эффективна только при создании новых сообщений.</em>',
	'ACL_F_NOAPPROVE'	=> 'Может размещать сообщения без одобрения',

	'ACL_F_ATTACH'		=> 'Может прикреплять вложения',
	'ACL_F_ICONS'		=> 'Может использовать значки тем/сообщений',
	'ACL_F_BBCODE'		=> 'Может использовать BBCode',
	'ACL_F_FLASH'		=> 'Может использовать BBCode [flash]',
	'ACL_F_IMG'			=> 'Может использовать BBCode [img]',
	'ACL_F_SIGS'		=> 'Может использовать подпись',
	'ACL_F_SMILIES'		=> 'Может использовать смайлики',

	'ACL_F_POLL'		=> 'Может создавать голосования',
	'ACL_F_VOTE'		=> 'Может голосовать в голосованиях',
...
$lang = array_merge($lang, array(
	...
	'ACL_M_SOFTDELETE'	=> 'Может помечать сообщения как удаленные<br /><em>Модераторы, у кторых есть право утверждать сообщения, могут восстанавливать сообщения помеченные как удаленные</em>',
	'ACL_M_APPROVE'		=> 'Может одобрять сообщения',
	'ACL_M_REPORT'		=> 'Может закрывать и удалять жалобы',
	'ACL_M_CHGPOSTER'	=> 'Может менять автора сообщения',

	'ACL_M_MOVE'	=> 'Может перемещать темы',
	'ACL_M_LOCK'	=> 'Может закрывать темы',
	'ACL_M_SPLIT'	=> 'Может разделять темы',
	'ACL_M_MERGE'	=> 'Может склеивать темы',

	'ACL_M_INFO'	=> 'Может просматривать информацию о сообщении',
...
// Admin Permissions
$lang = array_merge($lang, array(
	'ACL_A_BOARD'		=> 'Может изменять установки форума/проверять обновления',
	'ACL_A_SERVER'		=> 'Может изменять параметры настройки сервера',
	'ACL_A_JABBER'		=> 'Может изменять настройки Jabber',
	'ACL_A_PHPINFO'		=> 'Может просматривать настройки PHP',
	...
	'ACL_A_ICONS'		=> 'Может изменять значки тем/сообщений и смайлы',
	...
	'ACL_A_NAMES'		=> 'Может управлять запретом имен',
	...
	'ACL_A_EMAIL'		=> 'Может осуществлять массовую рассылку e-mail',
