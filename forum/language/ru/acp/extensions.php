...
$lang = array_merge($lang, array(
	...
	'EXTENSIONS_ADMIN'			=> 'Менеджер расширений',
	'EXTENSIONS_EXPLAIN'		=> 'Менеджер расширение представляет собой инструмент, который позволяет просмотреть информацию про ваши расширения и управлять ими.',
	'EXTENSION_INVALID_LIST'	=> 'Расширение "%s" не действует.<br /><p>%s</p>',
	'EXTENSION_NOT_AVAILABLE'	=> 'Выбранное расширение недоступно для этого форума, пожалуйста, проверьте, разрешены ли данные версии phpBB и PHP (посмотреть подробности).',
	...
	'EXT_DETAILS'			=> 'Подробности расширения',
	'DISPLAY_NAME'			=> 'Показать название',
	'CLEAN_NAME'			=> 'Очистить название',
	'TYPE'					=> 'Тип',
