...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'		=> 'Вы успешно сконвертировали Ваш форум в формат phpBB 3.1. Вы можете <a href="../">войти на форум</a>. Убедитесь, что все настройки успешно перенесены, прежде чем запустите форум, удалив папку install. Помните, что вспомогательную информацию по использованию phpBB можно получить в интернете, изучив <a href="http://www.phpbb.com/support/documentation/3.0/">документацию</a>, а также на <a href="https://www.phpbb.com/phpBB/viewforum.php?f=46">форуме поддержки</a> и портале <a href="http://bb3x.ru/" target="_blank">Русской поддержки phpBB3</a>',
...
// mbstring
	...
	'MYSQL_SCHEMA_UPDATE_REQUIRED'    => 'Структура Вашей базы данных MySQL для phpBB устарела. phpBB обнаружил структуру для базы данных MySQL 3.x/4.x, но сервер работает с MySQL %2$s.<br /><strong>Перед обновлением форума Вы должны обновить структуру базы данных.</strong><br /><br />Вы можете прочесть статью в <a href="https://www.phpbb.com/kb/article/doesnt-have-a-default-value-errors/">об обновлении структуры БД</a>. В случае возникновения проблем Вы можете обратиться на <a href="https://www.phpbb.com/community/viewforum.php?f=46">форум поддержки</a>.',
...
Также Вы можете прочесть <a href="http://bb3x.ru/a_main/main_install" target="_blank">статью "Установка форума"</a>, которая содержит более простое и понятное пошаговое описание процесса установки.<br /><br /><br /><br />Чтобы прочесть о лицензии phpBB3 и ознакомиться с информацией о получении поддержки, пожалуйста, кликните по соответствующей ссылке в боковом меню. Для продолжения кликните на соответствующей закладке вверху страницы. Для получения русскоязычной поддержки Вы можете использовать портал <a href="http://bb3x.ru/" target="_blank">Русской поддержки phpBB3</a>.',
	...
	'PHP_JSON_SUPPORT_EXPLAIN'    		=> '<strong>Рекомендации</strong> - Чтобы phpBB работал корректно, расширение PHP JSON extension должно быть доступно.',
	...
	'PHP_SETTINGS_EXPLAIN'				=> '<strong>Необходимо</strong> - Для установки phpBB требуется версия PHP не младше 5.3.3. Если ниже написано <var>Безопасный режим (Safe mode)</var>, то Ваш PHP работает в защищенном режиме. Это наложит ограничения на удаленное администрирование и аналогичные функции.',
	...
	'SELECT_FORUM_GA'				=> 'В phpBB 3.1 глобальные объявления являются ссылками на форум. выберите форум для текущих глобальных объявлений (позже Вы сможете его изменить):',
	'SOFTWARE'						=> 'Тип форума',
	...
	'STAGE_CREATE_TABLE_EXPLAIN'	=> 'Таблицы базы данных phpBB 3.1 были созданы и заполнены начальными данными. Переходите к следующему шагу для завершения установки phpBB.',
	...
	'SUPPORT_BODY'					=> 'Квалифицированную поддержку Вы можете получить <a href="https://www.phpbb.com/">на форумах поддержки phpBB 3.1.x</a> (на английском), или обратиться на <a href="http://bb3x.ru/">сайт русской поддержки форума phpBB3</a>. Там Вы сможете получить ответы на вопросы, связанные с установкой, проблемами настройки, конвертирования и проблемами общего характера. Также там можно обсудить нюансы создания и установки модов и стилей.</p><p>За дополнительной помощью обращайтесь к <a href="https://www.phpbb.com/support/documentation/3.0/quickstart/">Краткому руководству пользователя</a> (на английском), или к <a href="http://bb3x.ru/docs">русскоязычной документации</a>.</p><p>Чтобы быть в курсе последних новостей и следить за релизами, <a href="https://www.phpbb.com/support/">подпишитесь на рассылку сайта phpBB.com</a>. Подписаться на русскоязычную рассылку можно на сайте <a href="http://bb3x.ru/">BB3x.ru</a>.',
...
$lang = array_merge($lang, array(
	...
	'DATABASE_UPDATE_COMPLETE'				=> 'Обновление базы данных выполнено!',
	...
	'ERROR'				=> 'Ошибка',
	'EVERYTHING_UP_TO_DATE'		=> 'Все соответствует последней версии phpBB. Вам необходимо сейчас <a href="%1$s">авторизоваться на форуме</a> и проверить его работоспособность. Не забудьте удалить, переименовать или переместить папку install! Пожалуйста отправьте нам информацию о сервере и настройках конфигуриции форума из модуля <a href="%2$s">Отправки статистики</a> в Вашем ACP.',
...
Вам будут даны указания в ходе процесса обновления, а по его окончании Вам сообщат об этом.
	...
	'UPDATE_FILE_SUCCESS'				=> 'Обновление файла произведено успешно.',
