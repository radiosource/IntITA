 ...
 * @property string $TMName
 * @property string $TMDescription
 * @property string $TM
 */
class Theoreticalsmaterials extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('fkModuleID, fkLectureID, TMName, TMDescription, TM', 'required'),
			array('TMID, fkModuleID, fkLectureID', 'numerical', 'integerOnly'=>true),
			array('TMName, TMDescription', 'length', 'max'=>45),
			array('TM', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('TMID, fkModuleID, fkLectureID, TMName, TMDescription, TM', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('TMName',$this->TMName,true);
		$criteria->compare('TMDescription',$this->TMDescription,true);
