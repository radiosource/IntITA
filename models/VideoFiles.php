 ...
 * @property integer $VideoDurationSeconds
 */
class VideoFiles extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('fkModuleID, fkLectureID, VideoDurationSeconds', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			...
			'VideoURL' => 'Video',
			'VideoDurationSeconds' => 'Video duration (in seconds)',
		);
	}
