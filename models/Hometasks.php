...
class Hometasks extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('HomeTaskID, fkModuleID, fkLectureID, HomeTaskName, HomeTaskDescription, HomeTask', 'required'),
			array('HomeTaskID, fkModuleID, fkLectureID', 'numerical', 'integerOnly'=>true),
	...
	{
		return array(
			'HomeTaskID' => 'Home Task ID',
			'fkModuleID' => 'Module',
			'fkLectureID' => 'Lecture',
			'HomeTaskName' => 'Home Task Name',
